...
1. **[[workflow_state]]** — terminal machine-advancing **`deepen`** **`queue_entry_id` `resume-deepen-post-recal-0245-followup-gmm-20260325T031800Z`** (this continuation); **historical** same-subphase **`resume-deepen-post-second-pass-needs-work-gmm-20260325T020600Z`** (**AppendWitness** tranche); **historical** pass2 mint **`resume-deepen-post-pass2-41110-auditable-path-gmm-20260325T000321Z`**.

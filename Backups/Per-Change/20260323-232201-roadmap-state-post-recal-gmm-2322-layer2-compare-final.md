...
- **`last_run` vs deepen narrative:** Frontmatter **`last_recal_consistency_utc`** is **2026-03-23 23:18 UTC** (**`resume-recal-post-2136-followup-deepen-gmm-20260323T231800Z`**); **`last_deepen_narrative_utc`** remains **2026-03-23 22:12 UTC** for **`deepen`** **`resume-deepen-post-recal-2136-followup-gmm-20260323T221200Z`**. **`last_run`** (**2026-03-23-2322**) bumps **version** after **Layer-2** nested compare-final (**232200Z**) + coordination snapshots — still **not** a new **`deepen`** row. **Authoritative deepen cursor** is still **`workflow_state`** physical last **`## Log` deepen** row (**`last_auto_iteration`** **`resume-deepen-post-recal-2136-followup-gmm-20260323T221200Z`**) per **`workflow_log_authority: last_table_row`**. **Do not** infer cursor from **`Timestamp`** column sort alone when **`recal`** rows sit above that deepen row.
...
> **Physical last `workflow_state` `## Log` deepen row:** **`resume-deepen-post-recal-2136-followup-gmm-20260323T221200Z`** — **unchanged** (**`workflow_log_authority: last_table_row`**).

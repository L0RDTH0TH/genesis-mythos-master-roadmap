...
- **`last_run` vs deepen narrative:** Frontmatter **`last_recal_consistency_utc`** is **2026-03-23 23:18 UTC** (**`resume-recal-post-2136-followup-deepen-gmm-20260323T231800Z`**); **`last_deepen_narrative_utc`** is **2026-03-23 23:24 UTC** for **`deepen`** **`resume-deepen-post-recal-2318-layer2-compare-gmm-20260323T232400Z`** (**GMM-2318-L2**). **`last_run`** (**2026-03-23-2322**) bumped **version** after **Layer-2** nested compare-final (**232200Z**) + coordination snapshots — **then** a new **`deepen`** row landed **23:24 UTC** (**232400Z** queue id). **Authoritative deepen cursor** is **`workflow_state`** physical last **`## Log` deepen** row (**`last_auto_iteration`** **`resume-deepen-post-recal-2318-layer2-compare-gmm-20260323T232400Z`**) per **`workflow_log_authority: last_table_row`**. **Do not** infer cursor from **`Timestamp`** column sort alone when **`recal`** rows sit above that deepen row.

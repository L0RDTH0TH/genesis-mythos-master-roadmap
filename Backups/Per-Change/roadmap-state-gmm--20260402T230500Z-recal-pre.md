...
> [!warning] High context pressure (~73% util / threshold 80% in workflow log) — **RECAL-ROAD** follow-up queued per `roadmap-deepen` policy before next tertiary **3.2.1** deepen; queue `followup-deepen-phase3-32-gmm-20260402T230000Z` completed **3.2** secondary mint.

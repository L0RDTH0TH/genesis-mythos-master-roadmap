...
- **Index hygiene:** **`distilled-core`** `core_decisions` + **Core decisions** body for **Phase 3.4.9** must stay aligned with **`workflow_state`** **`last_ctx_util_pct`**, the physical last **`## Log`** row, and **`last_auto_iteration`** — **authoritative (2026-03-23):** **96%** + **`resume-deepen-post-recal-planned-pc349-gmm-20260323T213600Z`** (older examples e.g. **92%** + **`bs-gmm-deepen-20260322T201945Z-m4n8p2q6`** are **historical** only).

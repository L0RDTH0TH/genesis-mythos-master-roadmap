...
last_run: 2026-03-24-0217
version: 95
drift_score_last_recal: 0.04
handoff_drift_last_recal: 0.15
drift_metric_kind: qualitative_audit_v0
last_recal_consistency_utc: "2026-03-24-0217"
last_deepen_narrative_utc: "2026-03-24-0216"
---
...
- **Authoritative cursor (machine):** Use [[workflow_state]] frontmatter **`current_subphase_index`** **together with** the physical last **`## Log`** data row (**`workflow_log_authority: last_table_row`**). **Tertiary spine subphase (preserved):** **`4.1.1.1`** — [[phase-4-1-1-1-adapter-row-layout-registry-and-changelog-roadmap-2026-03-24-0228]] (parent [[phase-4-1-1-adapter-preimage-and-stable-column-layout-roadmap-2026-03-24-0018]]). **Latest `## Log` deepen row:** **`resume-deepen-post-handoff-audit-recal-gmm-20260324T021630Z`** (**2026-03-24 02:16** — quaternary **4.1.1.1** adapter registry / **D-032** stub); **`last_auto_iteration`** matches that id; **010800Z** = prior **major secondary widen** (**GMM-P4-1-SECONDARY-DEEPEN**); **03:00** **`resume-deepen-post-cursor-repair-p4-1-gmm-20260324T052800Z`** = **4.1** WBS stub row **above** terminal **021630Z** in table body — **do not** sort by Timestamp alone; **do not** treat stub or widen alone as **HR ≥ 93** / **REGISTRY-CI** closure without repo proof.
- **`last_run` vs deepen narrative (reconciled 2026-03-24 post–021700Z `recal`):** Frontmatter **`last_recal_consistency_utc`** is **`2026-03-24-0217`** (**`resume-recal-post-deepen-handoff-audit-gmm-20260324T021700Z`**). **`last_run`** / **`version`** reflect latest **`recal`** (**`2026-03-24-0217`**, **`95`**). **`last_deepen_narrative_utc`** remains **`2026-03-24-0216`** — matching the **terminal** queue-driven **`deepen`** **`resume-deepen-post-handoff-audit-recal-gmm-20260324T021630Z`** (quaternary **4.1.1.1**); **`recal`** does not advance deepen narrative clock. **`resume-deepen-post-cursor-repair-p4-1-gmm-20260324T052800Z`** (**D-063** WBS stub; **03:00** Timestamp in table) is **not** terminal vs **`workflow_log_authority: last_table_row`** (**021630Z** is the **last populated `deepen` data row** in the table body). **010800Z** remains the **major secondary widen** narrative anchor. **Do not** re-assert **`version` 93**, **`last_run` / narrative 0300**, or **052800Z** as **`last_auto_iteration`** / physical-last **`deepen`** — that was the **`state_hygiene_failure`** / **`contradictions_detected`** class cleared by **`repair-handoff-audit-layer1-post-lv-gmm-20260324T031600Z`**. **`workflow_state`** **`current_subphase_index`** remains **`4.1.1.1`**.
...
- Machine deepen anchor (current — duplicate of bullet above for MOC parsers): **`current_subphase_index`** **`4.1.1.1`** + **`last_auto_iteration`** **`resume-deepen-post-handoff-audit-recal-gmm-20260324T021630Z`** (terminal **`## Log`** **`deepen`** per **`workflow_log_authority: last_table_row`**); **052800Z** = historical **4.1** WBS stub only; **010800Z** = secondary widen anchor; tertiary mint **`resume-deepen-post-recal-p4-1-1-gmm-20260324T021500Z`** remains spine evidence.

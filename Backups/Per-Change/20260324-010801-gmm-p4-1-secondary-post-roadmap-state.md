...
last_deepen_narrative_utc: "2026-03-24-0021"
---
...
- **Authoritative cursor (machine):** Use [[workflow_state]] frontmatter `current_subphase_index` and the last `## Log` row (`last_auto_iteration` / `queue_entry_id` in Status/Next). **Live deepen cursor:** **`resume-deepen-post-recal-p4-1-1-gmm-20260324T021500Z`** / **`4.1.1.1`** — [[phase-4-1-1-1-adapter-row-layout-registry-and-changelog-roadmap-2026-03-24-0228]] (parent tertiary [[phase-4-1-1-adapter-preimage-and-stable-column-layout-roadmap-2026-03-24-0018]]). Prior **001800Z** **4.1.1** mint + **4.1** secondary + **4** primary operator deepen remain **spine evidence** in **`## Log`** only.
- **`last_run` vs deepen narrative:** Frontmatter **`last_recal_consistency_utc`** remains **2026-03-24-0020** (**`resume-recal-post-p4-1-1-deepen-gmm-20260324T002000Z`**) — **D-060** drift refresh after **4.1.1** mint (**`resume-deepen-phase4-primary-post-advance-idempotent-gmm-20260324T001800Z`**); **`last_deepen_narrative_utc`** (**2026-03-24-0021**) names the **latest** queue-driven **`deepen`** (**`resume-deepen-post-recal-p4-1-1-gmm-20260324T021500Z`**, **Phase 4.1.1.1** task — continuation **T-P4-01** + nested Research **[[Ingest/Agent-Research/phase-4-1-1-adapter-preimage-stable-layout-cqrs-research-2026-03-23-2205]]**). **`last_run`** (**2026-03-24-0021**) / **`version`** **87** include this **4.1.1.1** mint. **Authoritative machine cursor** for the **latest** queue-driven **`deepen`** is **`workflow_state`** **`last_auto_iteration`** **`resume-deepen-post-recal-p4-1-1-gmm-20260324T021500Z`** per **`workflow_log_authority: last_table_row`**.
...
- Machine deepen anchor (current — duplicate of bullet above for MOC parsers): same as **`last_auto_iteration`** **`resume-deepen-post-recal-p4-1-1-gmm-20260324T021500Z`** (**`4.1.1.1`**); **001800Z** **4.1.1** mint + **4.1** secondary + **4** primary operator deepen = prior spine evidence; operator **3.3.4** rollup historical only.

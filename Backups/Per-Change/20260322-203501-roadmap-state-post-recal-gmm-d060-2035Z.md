...
last_run: 2026-03-22-2035
version: 53
drift_score_last_recal: 0.04
handoff_drift_last_recal: 0.15
last_recal_consistency_utc: "2026-03-22-2035"
...
> **Nested validation:** First **`roadmap_handoff_auto`** + **IRA** + compare-final — see Run-Telemetry / `nested_subagent_ledger` on parent return (host **`Task(validator)`** / **`Task(internal-repair-agent)`** when available).

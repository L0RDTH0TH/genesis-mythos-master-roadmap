...
- Phase 3: in-progress (Phase **3.2** DM overwrite + regen gates — tertiary **3.2.2** opened — [[phase-3-2-2-regen-request-preconditions-and-gated-subgraph-contract-roadmap-2026-03-22-1735]])
- Phase 4: pending
- Phase 5: pending
- Phase 6: pending
...
- Latest deepen (current — Phase 3.2.2): [[phase-3-2-2-regen-request-preconditions-and-gated-subgraph-contract-roadmap-2026-03-22-1735]]
...
- **IRA / validator trace:** (filled after nested `roadmap_handoff_auto` cycle completes in Run-Telemetry)

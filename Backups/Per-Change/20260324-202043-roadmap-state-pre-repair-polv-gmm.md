...
- **Authoritative cursor (machine):** Use [[workflow_state]] frontmatter **`current_subphase_index`** **together with** the physical last **`## Log`** data row (**`workflow_log_authority: last_table_row`**). **Tertiary spine subphase (preserved):** **`4.1.1.1`** — [[phase-4-1-1-1-adapter-row-layout-registry-and-changelog-roadmap-2026-03-24-0228]] (parent [[phase-4-1-1-adapter-preimage-and-stable-column-layout-roadmap-2026-03-24-0018]]). **Latest `## Log` deepen row:** **`resume-deepen-post-recal-d060-021700z-gmm-20260324T021800Z`** (**2026-03-24 03:35** — post–**`resume-recal-post-deepen-handoff-audit-gmm-20260324T021700Z`** compare-final mirror: **`missing_acceptance_criteria`** ↔ **`normative_columns`** task wiring on quaternary **4.1.1.1**); **`last_auto_iteration`** matches that id on [[workflow_state]]. **Prior terminal (historical, still in table above 03:35 row):** **`resume-deepen-post-handoff-audit-recal-gmm-20260324T021630Z`** (**02:16** — adapter registry / **D-032** stub spine). **010800Z** = **major secondary widen**; **03:00** **`resume-deepen-post-cursor-repair-p4-1-gmm-20260324T052800Z`** = **4.1** WBS stub — **non-terminal**; **do not** sort by Timestamp alone.
- **`last_run` vs deepen narrative (reconciled 2026-03-24 post–033500Z nested validator):** Frontmatter **`last_recal_consistency_utc`** remains **`2026-03-24-0217`** (**`resume-recal-post-deepen-handoff-audit-gmm-20260324T021700Z`**). **`last_run`** / **`version`** advanced for **post–first-pass IRA hygiene** (**`2026-03-24-0335`**, **`96`**) after **`.technical/Validator/roadmap-handoff-auto-genesis-mythos-master-20260324T033500Z-deepen-d060-mirror-first.md`** (**`contradictions_detected`** / **`state_hygiene_failure`** — dual-truth vs **`workflow_state`**). **`last_deepen_narrative_utc`** → **`2026-03-24-0335`** matching the **terminal** **`deepen`** **`resume-deepen-post-recal-d060-021700z-gmm-20260324T021800Z`**. **`021630Z`** deepen remains **valid historical** row in **`## Log`** body (appears **above** **03:35** row) — **not** the live cursor. **`workflow_state`** **`current_subphase_index`** remains **`4.1.1.1`**.
...
- Machine deepen anchor (current — duplicate of bullet above for MOC parsers): **`current_subphase_index`** **`4.1.1.1`** + **`last_auto_iteration`** **`resume-deepen-post-recal-d060-021700z-gmm-20260324T021800Z`** (terminal **`## Log`** **`deepen`** per **`workflow_log_authority: last_table_row`** on [[workflow_state]]); **021630Z** = prior quaternary deepen row (historical vs **03:35** terminal); **052800Z** = historical **4.1** WBS stub only; **010800Z** = secondary widen anchor; tertiary mint **`resume-deepen-post-recal-p4-1-1-gmm-20260324T021500Z`** remains spine evidence.

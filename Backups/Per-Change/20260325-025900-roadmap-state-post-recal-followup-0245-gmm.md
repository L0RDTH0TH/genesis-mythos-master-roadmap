...
- **Authoritative cursor (machine):** Use [[workflow_state]] frontmatter **`current_subphase_index` `4.1.1.10`** **with** **`last_auto_iteration` `resume-deepen-post-pass2-41110-auditable-path-gmm-20260325T000321Z`** (**`workflow_log_authority: last_table_row`**). **Live quaternary:** [[phase-4-1-1-10-auditable-path-check-contract-and-example-witness-appendix-roadmap-2026-03-25-0003]] (post–pass2 validator **`next_artifacts`**; follows witness **4.1.1.9** [[phase-4-1-1-9-bundle-verification-witness-and-rollback-runbook-roadmap-2026-03-24-2304]] → protocol [[phase-4-1-1-8-operator-evidence-index-and-bundle-ingest-protocol-roadmap-2026-03-25-1200]] → bundle [[phase-4-1-1-7-adapter-registry-rollup-handoff-bundle-and-closure-map-roadmap-2026-03-24-0926]] under [[phase-4-1-1-adapter-preimage-and-stable-column-layout-roadmap-2026-03-24-0018]]). **Terminal `## Log` deepen (id authority):** **`resume-deepen-post-pass2-41110-auditable-path-gmm-20260325T000321Z`** (**2026-03-25 00:03 UTC**, queue **`resume-deepen-followup-post-pass2-gmm-20260325T013100Z`**). **Prior machine-advancing witness quaternary (historical):** **`resume-deepen-a1b-pc-empty-bootstrap-gmm-20260324T230356Z`** @ **`4.1.1.9`** (**2026-03-24 23:03**). **Historical protocol deepen (4.1.1.8):** **`gmm-conceptual-deepen-one-step-20260325T120002Z`** (**2026-03-25 12:00** — timestamp vs slug per cross-link note). **Prior bundle deepen (historical id):** **`resume-deepen-post-recal-post-empty-bootstrap-gmm-20260324T092634Z`**. **Last populated log row** may be **`deepen` `2026-03-25 00:03`**; older **`handoff-audit`** rows remain audit-only. **Historical deepen:** **`021800Z`**, **`021630Z`**, **0335** mirror chain; **010800Z** secondary widen; **052800Z** **4.1** WBS stub **non-terminal**.
- **`last_run` vs deepen narrative:** **Live YAML** on this file (**frontmatter**) = **`last_run` `2026-03-25-0259`**, **`version` `113`**, **`last_deepen_narrative_utc` `2026-03-25-0003`** (**`last_deepen_narrative_utc`** still anchors the **00:03 UTC** **4.1.1.10** machine-advancing deepen; **`last_run`/`version`** bumped by **2026-03-24 23:59 UTC** **`recal`** **`followup-recal-post-cursor-repair-gmm-20260325T024500Z`** — **D-060** drift refresh only, **no** cursor advance). **Last machine-advancing deepen** = **4.1.1.10** auditable-path check, queue **`resume-deepen-followup-post-pass2-gmm-20260325T013100Z`**. Prior **23:03 UTC** **A.1b** bootstrap @ **4.1.1.9** (**`resume-deepen-a1b-pc-empty-bootstrap-gmm-20260324T230356Z`**) is **historical** relative to this cursor. **`last_recal_consistency_utc`** = **`2026-03-25-0259`** (see [[workflow_state]] **23:59** **recal** row **`followup-recal-post-cursor-repair-gmm-20260325T024500Z`** + **Consistency reports** here). **Historical handoff-audit repair** (`repair-gmm-handoff-audit-post-lv-2026-03-24T210830Z`) **as-of 12:00 UTC** cited **`last_run` `2026-03-24-1200`**, **`version` `105`**, **`last_deepen_narrative_utc` `2026-03-24-0926`** — that triple is **superseded**; do not parse it as current machine state. **Repair (2026-03-24 UTC — queue `repair-l1-postlv-roadmap-live-yaml-gmm-20260324T183500Z`):** aligned this bullet to frontmatter per **`.technical/Validator/roadmap-auto-validation-genesis-mythos-master-20260324T183000Z-layer1-postlv-after-handoff-repair.md`** (**`state_hygiene_failure`**: prior body had falsely claimed **`version` `111`** / **`last_run` `2026-03-25-0003`** as the live **`last_run`**).
...
- Machine deepen anchor (current — duplicate of bullet above for MOC parsers): **`current_subphase_index` `4.1.1.10`** + **`last_auto_iteration` `resume-deepen-post-pass2-41110-auditable-path-gmm-20260325T000321Z`** on [[workflow_state]]; **`resume-deepen-a1b-pc-empty-bootstrap-gmm-20260324T230356Z`** = prior **4.1.1.9** witness bootstrap (**historical**); **`gmm-conceptual-deepen-one-step-20260325T120002Z`** = prior **4.1.1.8** protocol deepen (**historical id** vs live cursor); **`resume-deepen-post-recal-post-empty-bootstrap-gmm-20260324T092634Z`** = prior **4.1.1.7** bundle deepen (**historical**); **021800Z** / **021630Z** / **0335** chain = **historical**; **052800Z** = **4.1** WBS stub; **010800Z** = secondary widen; **`resume-deepen-post-recal-p4-1-1-gmm-20260324T021500Z`** = spine evidence (historical).

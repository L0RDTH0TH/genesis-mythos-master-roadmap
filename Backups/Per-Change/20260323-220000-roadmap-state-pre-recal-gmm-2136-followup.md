...
- **`last_run` vs deepen narrative:** Frontmatter **`last_recal_consistency_utc`** remains **2026-03-23 21:22 UTC** (**`resume-recal-post-planned-deepen-pc349-gmm-20260323T130100Z`**); **`last_run` / `last_deepen_narrative_utc`** advance to **2026-03-23 21:36 UTC** for **`deepen`** **`resume-deepen-post-recal-planned-pc349-gmm-20260323T213600Z`**. **Authoritative deepen cursor** is **`workflow_state`** physical last **`## Log`** **deepen** row (**2026-03-23 21:36 UTC**, **`last_auto_iteration`** **`resume-deepen-post-recal-planned-pc349-gmm-20260323T213600Z`**) per **`workflow_log_authority: last_table_row`**. **Do not** infer cursor from **`Timestamp`** column sort alone when **`recal`** rows sit above that deepen row.

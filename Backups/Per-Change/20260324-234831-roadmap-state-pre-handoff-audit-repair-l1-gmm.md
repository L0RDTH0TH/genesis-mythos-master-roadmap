...
- **`last_run` vs deepen narrative:** **Live YAML** on this file (**frontmatter**) = **`last_run` `2026-03-24-2303`**, **`version` `109`**, **`last_deepen_narrative_utc` `2026-03-24-2303`** (post–**A.1b** empty-queue bootstrap deepen **queue `a1b-pc-resume-gmm-20260324T201830Z-7f3c`**). **`last_recal_consistency_utc`** remains **`2026-03-24-0918`** (see [[workflow_state]] **09:18** **recal** row). **Historical handoff-audit repair** (`repair-gmm-handoff-audit-post-lv-2026-03-24T210830Z`) **as-of 12:00 UTC** cited **`last_run` `2026-03-24-1200`**, **`version` `105`**, **`last_deepen_narrative_utc` `2026-03-24-0926`** — that triple is **superseded by later deepens**; do not parse it as current machine state.

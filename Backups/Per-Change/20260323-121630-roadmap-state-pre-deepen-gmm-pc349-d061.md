...
**Nested validation (2026-03-23 RESUME_ROADMAP `recal` `resume-recal-post-pc349-followup-deepen-gmm-20260323T121530Z`):** **D-060** follow-up keyed to **planned / idempotency-chain** deepen id **`resume-deepen-post-recal-pc349-gmm-20260323T121500Z`** (Ctx **95%** **>** threshold **80** per queue `user_guidance` — **no** matching **`## Log`** **deepen** row yet); compare-final cite **`.technical/Validator/roadmap-auto-validation-genesis-mythos-master-20260323T121000Z-gmm-pc349-recal-d060-compare-final.md`**; **rollup HR 92 < 93** + **G-P*.*-REGISTRY-CI HOLD** unchanged (**drift refresh only**); authoritative **`## Log`** **deepen** cursor remains **`resume-deepen-post-layer1-recal-gmm-20260323T022200Z`** per **`workflow_log_authority: last_table_row`** until that planned deepen is logged.
...
- **`last_run` vs deepen narrative:** Frontmatter **`last_recal_consistency_utc`** / **`last_run`** track the **2026-03-23 12:15 UTC** RECAL consistency heading (`resume-recal-post-pc349-followup-deepen-gmm-20260323T121530Z`); **`last_deepen_narrative_utc`** remains a deepen-anchor label — **authoritative deepen cursor** is **`workflow_state`** physical last **`## Log`** **deepen** row (**2026-03-23 02:22 UTC**, **`last_auto_iteration`** **`resume-deepen-post-layer1-recal-gmm-20260323T022200Z`**) per **`workflow_log_authority: last_table_row`**. **Do not** infer cursor from **`Timestamp`** column sort alone when **`recal`** rows sit above that deepen row.

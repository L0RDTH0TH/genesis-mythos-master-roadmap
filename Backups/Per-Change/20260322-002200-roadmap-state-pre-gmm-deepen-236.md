...
- Phase 3: in-progress (3.1.2 tertiary opened — [[phase-3-1-2-deterministic-catch-up-caps-multirate-fairness-roadmap-2026-03-22-0016]])
- Phase 4: pending
- Phase 5: pending
- Phase 6: pending
...
- Research note suffix vs log time: pre-deepen synthesis [[Ingest/Agent-Research/deterministic-sim-scheduler-catchup-multirate-fairness-research-2026-03-22-2205.md]] uses a filename timestamp label; do not infer ordering against workflow log timestamps (e.g. `2026-03-22 00:16`).

...
- Latest deepen (current — Phase 3.2.1): [[phase-3-2-1-dm-override-intent-envelope-and-regeneration-gate-taxonomy-roadmap-2026-03-22-0210]]
...
- **IRA / validator trace:** (filled after nested `roadmap_handoff_auto` cycle in Run-Telemetry / `.technical/Validator/`)

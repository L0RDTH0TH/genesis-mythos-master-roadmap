...
last_recal_consistency_utc: "2026-03-23-1215"
...
- **`last_run` vs deepen narrative:** Frontmatter **`last_recal_consistency_utc`** remains **2026-03-23 12:15 UTC** (**`resume-recal-post-pc349-followup-deepen-gmm-20260323T121530Z`**); **`last_run` / `last_deepen_narrative_utc`** advance to **2026-03-23 12:16 UTC** for the **planned-chain** **`deepen`** (`resume-deepen-post-recal-pc349-gmm-20260323T121500Z`). **Authoritative deepen cursor** is **`workflow_state`** physical last **`## Log`** **deepen** row (**2026-03-23 12:16 UTC**, **`last_auto_iteration`** **`resume-deepen-post-recal-pc349-gmm-20260323T121500Z`**) per **`workflow_log_authority: last_table_row`**. **Do not** infer cursor from **`Timestamp`** column sort alone when **`recal`** rows sit above that deepen row.

...
- **`last_run` vs deepen narrative:** Frontmatter **`last_recal_consistency_utc`** is **2026-03-24 01:12 UTC** (**`resume-recal-post-232400Z-deepen-gmm-20260324T011200Z`**); **`last_deepen_narrative_utc`** is **2026-03-23 23:24 UTC** for **`deepen`** **`resume-deepen-post-recal-2318-layer2-compare-gmm-20260323T232400Z`** (**GMM-2318-L2**). **`last_run`** (**2026-03-24-0112**) / **`version`** **78** reflect the **2026-03-24 01:12 UTC** **`recal`** + **Notes** prose sync after **232400Z** deepen + YAML narrative reconcile (**010530Z** hygiene compare-final path). **Historical:** **`last_run`** **2026-03-23-2322** / **`version`** **76** after **232200Z** Layer-2 compare-final + coordination snapshots **before** the **23:24 UTC** deepen row. **Authoritative deepen cursor** is **`workflow_state`** physical last **`## Log` deepen** row (**`last_auto_iteration`** **`resume-deepen-post-recal-2318-layer2-compare-gmm-20260323T232400Z`**) per **`workflow_log_authority: last_table_row`** (**`recal`** **01:12** row is **below** that deepen row in the table). **Do not** infer cursor from **`Timestamp`** column sort alone when **`recal`** rows are interleaved with **deepen** rows.

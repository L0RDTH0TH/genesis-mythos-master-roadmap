...
- **`last_run` vs deepen narrative:** Frontmatter **`last_recal_consistency_utc`** remains **2026-03-23 22:00 UTC** (**`resume-recal-post-planned-deepen-2136-followup-gmm-20260323T214500Z`**); **`last_deepen_narrative_utc`** advances to **2026-03-23 22:12 UTC** for **`deepen`** **`resume-deepen-post-recal-2136-followup-gmm-20260323T221200Z`**. **`last_run`** reflects this **`deepen`** (**2026-03-23-2212**). **Authoritative deepen cursor** is **`workflow_state`** physical last **`## Log` deepen** row (**`last_auto_iteration`** **`resume-deepen-post-recal-2136-followup-gmm-20260323T221200Z`**) per **`workflow_log_authority: last_table_row`**. **Do not** infer cursor from **`Timestamp`** column sort alone when **`recal`** rows sit above that deepen row.

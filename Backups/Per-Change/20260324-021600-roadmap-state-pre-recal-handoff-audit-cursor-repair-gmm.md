...
last_recal_consistency_utc: "2026-03-24-0125"
...
- **`last_run` vs deepen narrative (reconciled 2026-03-24 repair):** Frontmatter **`last_recal_consistency_utc`** is **`2026-03-24-0125`** (**`resume-recal-post-p4-1-secondary-deepen-gmm-20260324T012500Z`**) — **D-060** drift refresh after **Phase 4.1 secondary** **`deepen`** **`resume-deepen-phase4-1-player-first-gmm-20260324T010800Z`**; prior **0020Z** **recal** after **4.1.1** mint remains **historical** in **Consistency reports** / **Notes** above, **not** the live scalar. **`last_deepen_narrative_utc`** (**2026-03-24-0108**) names the **latest** queue-driven **`deepen`** (**`resume-deepen-phase4-1-player-first-gmm-20260324T010800Z`**, **Phase 4.1 secondary** — nested Research **[[Ingest/Agent-Research/phase-4-1-secondary-player-first-read-rig-research-2026-03-24.md]]**). **`last_run`** (**2026-03-24-0108**) / **`version`** **89** match YAML and include the **0125Z** **recal** version bump. **Physical last `## Log` row** = **`resume-deepen-phase4-1-player-first-gmm-20260324T010800Z`** per **`workflow_log_authority: last_table_row`**; **`workflow_state`** **`current_subphase_index`** remains **`4.1.1.1`** (**`resume-deepen-post-recal-p4-1-1-gmm-20260324T021500Z`**) per operator serialism. **Repair cite:** [[.technical/Validator/roadmap-auto-validation-20260324T031800Z-p4-1-recal-012500Z-layer1-post-lv.md]] (**`state_hygiene_failure`** dual-truth cleared).

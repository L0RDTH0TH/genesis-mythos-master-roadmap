...
- **Authoritative cursor (machine):** Use [[workflow_state]] frontmatter `current_subphase_index` and the last `## Log` row (`last_auto_iteration` / `queue_entry_id` in Status/Next). **Live deepen cursor:** **`resume-deepen-phase4-primary-post-advance-idempotent-gmm-20260324T001800Z`** / **`4.1.1`** — [[phase-4-1-1-adapter-preimage-and-stable-column-layout-roadmap-2026-03-24-0018]]. Prior **4.1** secondary mint + **4** primary operator deepen remain **spine evidence** in **`## Log`** only.
- **`last_run` vs deepen narrative:** Frontmatter **`last_recal_consistency_utc`** is **2026-03-24-0020** (**`resume-recal-post-p4-1-1-deepen-gmm-20260324T002000Z`**) — **D-060** drift refresh after **4.1.1** mint (**`resume-deepen-phase4-primary-post-advance-idempotent-gmm-20260324T001800Z`**); prior **01:12 UTC** **RECAL** (**`resume-recal-post-232400Z-deepen-gmm-20260324T011200Z`**) remains **historical** for the **232400Z** **3.4.9** chain. **`last_deepen_narrative_utc`** (**2026-03-24-0018**) names the **latest** queue-driven **`deepen`** (**`resume-deepen-phase4-primary-post-advance-idempotent-gmm-20260324T001800Z`**, **Phase 4.1.1** tertiary — **T-P4-01** / **D-059**); **Phase 4 primary** operator deepen (**`operator-deepen-phase4-primary-gmm-20260324T003000Z`**, **GMM-P4-PRIMARY-DEEPEN**) and **first 4.1 secondary** mint (**`resume-deepen-phase4-first-gmm-20260324T000001Z`**) remain **prior spine evidence** in **`## Log`**. **`last_run`** (**2026-03-24-0020**) / **`version`** **86** reflect **P4.1.1** follow-up **recal** + **rollup HR 92 < 93** + **REGISTRY-CI HOLD** vault-honest stance. **Authoritative machine cursor** for the **latest** queue-driven **`deepen`** is **`workflow_state`** **`last_auto_iteration`** **`resume-deepen-phase4-primary-post-advance-idempotent-gmm-20260324T001800Z`** per **`workflow_log_authority: last_table_row`**.
...
- Machine deepen anchor (current — duplicate of bullet above for MOC parsers): same as **`last_auto_iteration`** **`resume-deepen-phase4-primary-post-advance-idempotent-gmm-20260324T001800Z`** (**`4.1.1`**); **4.1** secondary mint + **4** primary operator deepen = prior spine evidence; operator **3.3.4** rollup historical only.
...
> **Physical last `workflow_state` `## Log` deepen row (authoritative cursor):** **`resume-deepen-phase4-primary-post-advance-idempotent-gmm-20260324T001800Z`** — unchanged (**`workflow_log_authority: last_table_row`**).

...
last_run: 2026-03-22-1200
version: 47
drift_score_last_recal: 0.04
handoff_drift_last_recal: 0.15
last_recal_consistency_utc: "2026-03-22-1200"
last_deepen_narrative_utc: "2026-03-22-1205"
---
...
- **`last_run` vs deepen narrative:** Frontmatter **`last_recal_consistency_utc`** / **`last_deepen_narrative_utc`** record **wall-clock labels** for the **12:00** RECAL consistency block vs the **12:05** deepen report below; **`last_run`** matches the latest **roadmap-state** YAML mutation (here: post-RECAL drift fields). **Canonical ordering** for automation remains **[[workflow_state]]** + **`workflow_log_authority: last_table_row`** (see **workflow_state** Notes **2026-03-22** for `recal` row placement).
...
- Latest deepen (current — Phase 3.4.8): [[phase-3-4-8-high-context-util-policy-and-phase-4-stub-readiness-roadmap-2026-03-22-1205]]
...
> **Cross-check:** Current tertiary **3.4.8**, **decisions-log** (**D-060**, **D-044**, **D-059**, rollup **HOLD** rows), and **distilled-core** `core_decisions` **align**; no contradictory “closed” claims vs documented **HOLD** gates (**G-P3.2**, **G-P3.3**, **G-P3.4**).  
...
- **Inputs read for this `recal` pass:** [[decisions-log]] (through **D-060**), [[distilled-core]] `core_decisions`, [[workflow_state]] (cursor + last deepen metrics), [[roadmap-state]] Phase summaries / Notes, current tertiary [[phase-3-4-8-high-context-util-policy-and-phase-4-stub-readiness-roadmap-2026-03-22-1205]], rollup anchors **3.2.4** / **3.3.4** / **3.4.4** (vault paths under `Roadmap/Phase-3-Living-Simulation-and-Dynamic-Agency/`).

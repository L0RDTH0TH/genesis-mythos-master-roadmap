...
proposal_path: Ingest/Decisions/Ingest-Decisions/Decision-for-Blender-mcp--2026-03-05-0215.md
original_note: [[Blender mcp.md]]
original_path: Ingest/Blender mcp.md
...
# Decision: Where should [[Blender mcp]] go?

**Classifier top candidates** (ranked by confidence):

- [ ] **A.** 3-Resources/Blender mcp.md — 40%  
  Direct under PARA root

- [ ] **B.** 1-Projects/Blender mcp.md — 5%  
  Direct under 1-Projects

- [ ] **C.** 2-Areas/Blender mcp.md — 5%  
  Direct under 2-Areas

- [ ] **D.** 4-Archives/Blender mcp.md — 5%  
  Direct under 4-Archives

- [ ] **E.** 3-Resources/Unfiled/Blender mcp.md — 5%  
  3-Resources/Unfiled

- [ ] **F.** 4-Archives/Ingest-2026-03-05/Blender mcp.md — 5%  
  4-Archives/Ingest-YYYY-MM-DD

- [ ] **G.** 3-Resources/Unfiled-Alt/Blender mcp.md — 5%  

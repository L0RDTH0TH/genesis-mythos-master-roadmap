...
proposal_path: Ingest/Decisions/Ingest-Decisions/Decision-for-Cascade-Portal--2026-03-05-0215.md
original_note: [[Cascade Portal.md]]
original_path: Ingest/Cascade Portal.md
...
# Decision: Where should [[Cascade Portal]] go?

**Classifier top candidates** (ranked by confidence):

- [ ] **A.** 3-Resources/Cascade Portal.md — 40%  
  Direct under PARA root

- [ ] **B.** 1-Projects/Cascade Portal.md — 5%  
  Direct under 1-Projects

- [ ] **C.** 2-Areas/Cascade Portal.md — 5%  
  Direct under 2-Areas

- [ ] **D.** 4-Archives/Cascade Portal.md — 5%  
  Direct under 4-Archives

- [ ] **E.** 3-Resources/Unfiled/Cascade Portal.md — 5%  
  3-Resources/Unfiled

- [ ] **F.** 4-Archives/Ingest-2026-03-05/Cascade Portal.md — 5%  
  4-Archives/Ingest-YYYY-MM-DD

- [ ] **G.** 3-Resources/Unfiled-Alt/Cascade Portal.md — 5%  

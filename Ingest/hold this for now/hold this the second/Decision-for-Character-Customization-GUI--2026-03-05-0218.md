...
proposal_path: Ingest/Decisions/Ingest-Decisions/Decision-for-Character-Customization-GUI--2026-03-05-0218.md
original_note: [[Character Customization GUI.md]]
original_path: Ingest/Character Customization GUI.md
...
# Decision: Where should [[Character Customization GUI]] go?

**Classifier top candidates** (ranked by confidence):

- [ ] **A.** 2-Areas/Character Customization GUI.md — 41%  
  Direct under PARA root

- [ ] **B.** 1-Projects/Character Customization GUI.md — 5%  
  Direct under 1-Projects

- [ ] **C.** 3-Resources/Character Customization GUI.md — 5%  
  Direct under 3-Resources

- [ ] **D.** 4-Archives/Character Customization GUI.md — 5%  
  Direct under 4-Archives

- [ ] **E.** 3-Resources/Unfiled/Character Customization GUI.md — 5%  
  3-Resources/Unfiled

- [ ] **F.** 4-Archives/Ingest-2026-03-05/Character Customization GUI.md — 5%  
  4-Archives/Ingest-YYYY-MM-DD

- [ ] **G.** 2-Areas/Unfiled/Character Customization GUI.md — 5%  

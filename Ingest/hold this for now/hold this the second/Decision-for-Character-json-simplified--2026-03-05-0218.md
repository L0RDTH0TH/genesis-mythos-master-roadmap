...
proposal_path: Ingest/Decisions/Ingest-Decisions/Decision-for-Character-json-simplified--2026-03-05-0218.md
original_note: [[Character json simplified.md]]
original_path: Ingest/Character json simplified.md
...
# Decision: Where should [[Character json simplified]] go?

**Classifier top candidates** (ranked by confidence):

- [ ] **A.** 4-Archives/Pre-Archive-Root-Cleanup/Character json simplified.md — 40%  
  Under 4-Archives/Pre-Archive-Root-Cleanup

- [ ] **B.** 4-Archives/Ingest-2026-03-01/Character json simplified.md — 40%  
  Under 4-Archives/Ingest-2026-03-01

- [ ] **C.** 4-Archives/Genesis/Character json simplified.md — 40%  
  Under 4-Archives/Genesis

- [ ] **D.** 4-Archives/Test-Project-Archive/Character json simplified.md — 40%  
  Under 4-Archives/Test-Project-Archive

- [ ] **E.** 4-Archives/Ingest-Decisions/Character json simplified.md — 41%  
  Under 4-Archives/Ingest-Decisions

- [ ] **F.** 1-Projects/Character json simplified.md — 5%  
  Direct under 1-Projects

- [ ] **G.** 3-Resources/Unfiled/Character json simplified.md — 5%  
  3-Resources/Unfiled

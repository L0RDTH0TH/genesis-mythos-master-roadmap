...
proposal_path: Ingest/Decisions/Ingest-Decisions/Decision-for-AI-Integration--2026-03-05-0215.md
original_note: [[AI Integration.md]]
original_path: Ingest/AI Integration.md
...
# Decision: Where should [[AI Integration]] go?

**Classifier top candidates** (ranked by confidence):

- [ ] **A.** 2-Areas/AI Integration.md — 41%  
  Direct under PARA root

- [ ] **B.** 1-Projects/AI Integration.md — 5%  
  Direct under 1-Projects

- [ ] **C.** 3-Resources/AI Integration.md — 5%  
  Direct under 3-Resources

- [ ] **D.** 4-Archives/AI Integration.md — 5%  
  Direct under 4-Archives

- [ ] **E.** 3-Resources/Unfiled/AI Integration.md — 5%  
  3-Resources/Unfiled

- [ ] **F.** 4-Archives/Ingest-2026-03-05/AI Integration.md — 5%  
  4-Archives/Ingest-YYYY-MM-DD

- [ ] **G.** 2-Areas/Unfiled/AI Integration.md — 5%  

...
proposal_path: Ingest/Decisions/Ingest-Decisions/Decision-for-Cascade-Breadcrumb--2026-03-05-0215.md
original_note: [[Cascade Breadcrumb.md]]
original_path: Ingest/Cascade Breadcrumb.md
...
# Decision: Where should [[Cascade Breadcrumb]] go?

**Classifier top candidates** (ranked by confidence):

- [ ] **A.** 4-Archives/Pre-Archive-Root-Cleanup/Cascade Breadcrumb.md — 47%  
  Under 4-Archives/Pre-Archive-Root-Cleanup

- [ ] **B.** 4-Archives/Ingest-2026-03-01/Cascade Breadcrumb.md — 40%  
  Under 4-Archives/Ingest-2026-03-01

- [ ] **C.** 4-Archives/Test-Project-Archive/Cascade Breadcrumb.md — 40%  
  Under 4-Archives/Test-Project-Archive

- [ ] **D.** 4-Archives/Genesis/Cascade Breadcrumb.md — 40%  
  Under 4-Archives/Genesis

- [ ] **E.** 4-Archives/Ingest-Decisions/Cascade Breadcrumb.md — 41%  
  Under 4-Archives/Ingest-Decisions

- [ ] **F.** 1-Projects/Cascade Breadcrumb.md — 5%  
  Direct under 1-Projects

- [ ] **G.** 3-Resources/Unfiled/Cascade Breadcrumb.md — 5%  
  3-Resources/Unfiled

...
proposal_path: Ingest/Decisions/Ingest-Decisions/Decision-for-Biome-Properties--2026-03-05-0215.md
original_note: [[Biome Properties.md]]
original_path: Ingest/Biome Properties.md
...
# Decision: Where should [[Biome Properties]] go?

**Classifier top candidates** (ranked by confidence):

- [ ] **A.** 3-Resources/Biome Properties.md — 40%  
  Direct under PARA root

- [ ] **B.** 1-Projects/Biome Properties.md — 5%  
  Direct under 1-Projects

- [ ] **C.** 2-Areas/Biome Properties.md — 5%  
  Direct under 2-Areas

- [ ] **D.** 4-Archives/Biome Properties.md — 5%  
  Direct under 4-Archives

- [ ] **E.** 3-Resources/Unfiled/Biome Properties.md — 5%  
  3-Resources/Unfiled

- [ ] **F.** 4-Archives/Ingest-2026-03-05/Biome Properties.md — 5%  
  4-Archives/Ingest-YYYY-MM-DD

- [ ] **G.** 3-Resources/Unfiled-Alt/Biome Properties.md — 5%  

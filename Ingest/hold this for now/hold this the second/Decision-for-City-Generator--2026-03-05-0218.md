...
proposal_path: Ingest/Decisions/Ingest-Decisions/Decision-for-City-Generator--2026-03-05-0218.md
original_note: [[City Generator.md]]
original_path: Ingest/City Generator.md
...
# Decision: Where should [[City Generator]] go?

**Classifier top candidates** (ranked by confidence):

- [ ] **A.** 3-Resources/City Generator.md — 40%  
  Direct under PARA root

- [ ] **B.** 1-Projects/City Generator.md — 5%  
  Direct under 1-Projects

- [ ] **C.** 2-Areas/City Generator.md — 5%  
  Direct under 2-Areas

- [ ] **D.** 4-Archives/City Generator.md — 5%  
  Direct under 4-Archives

- [ ] **E.** 3-Resources/Unfiled/City Generator.md — 5%  
  3-Resources/Unfiled

- [ ] **F.** 4-Archives/Ingest-2026-03-05/City Generator.md — 5%  
  4-Archives/Ingest-YYYY-MM-DD

- [ ] **G.** 2-Areas/Unfiled/City Generator.md — 5%  

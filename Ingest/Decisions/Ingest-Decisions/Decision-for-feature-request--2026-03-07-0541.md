...
proposal_path: Ingest/Decisions/Ingest-Decisions/Decision-for-feature-request--2026-03-07-0541.md
original_note: [[Feature Request.md]]
original_path: Ingest/Feature Request.md
...
# Decision: Where should [[Feature Request.md]] go?

**Classifier top candidates** (ranked by confidence):

- [ ] **A.** 4-Archives/Pre-Archive-Root-Cleanup/Feature Request.md — 42%  
  Under 4-Archives/Pre-Archive-Root-Cleanup

- [ ] **B.** 4-Archives/Ingest-2026-03-01/Feature Request.md — 40%  
  Under 4-Archives/Ingest-2026-03-01

- [ ] **C.** 4-Archives/Resources/Feature Request.md — 40%  
  Under 4-Archives/Resources

- [ ] **D.** 4-Archives/Genesis/Feature Request.md — 40%  
  Under 4-Archives/Genesis

- [ ] **E.** 4-Archives/Ingest-Decisions/Feature Request.md — 40%  
  Under 4-Archives/Ingest-Decisions

- [ ] **F.** 4-Archives/Areas/Feature Request.md — 40%  
  Under 4-Archives/Areas

- [ ] **G.** 4-Archives/Projects/Feature Request.md — 40%  

...
proposal_path: Ingest/Decisions/Ingest-Decisions/Decision-for-feature-request-template--2026-03-07-0541.md
original_note: [[Feature request template.md]]
original_path: Ingest/Feature request template.md
...
# Decision: Where should [[Feature request template.md]] go?

**Classifier top candidates** (ranked by confidence):

- [ ] **A.** 3-Resources/Feature request template.md — 45%  
  Direct under PARA root

- [ ] **B.** 3-Resources/Feature-request-temp/Feature request template.md — 40%  
  ⚠ Potential new folder: Feature-request-temp

- [ ] **C.** 3-Resources/Unfiled/Feature request template.md — 40%  
  ⚠ Potential new folder: Unfiled

- [ ] **D.** 3-Resources/Inbox/Feature request template.md — 40%  
  ⚠ Potential new folder: Inbox

- [ ] **E.** 3-Resources/Misc/Feature request template.md — 40%  
  ⚠ Potential new folder: Misc

- [ ] **F.** 3-Resources/New/Feature request template.md — 40%  
  ⚠ Potential new folder: New

- [ ] **G.** 3-Resources/Ideas/Feature request template.md — 40%  

...
proposal_path: Ingest/Decisions/Ingest-Decisions/Decision-for-minecraft-beta--2026-03-07-0541.md
...
- [ ] **A.** 3-Resources/minecraft-beta.md — 40%  
  Direct under PARA root

- [ ] **B.** 3-Resources/minecraft-beta/minecraft-beta.md — 40%  
  ⚠ Potential new folder: minecraft-beta

- [ ] **C.** 3-Resources/Unfiled/minecraft-beta.md — 40%  
  ⚠ Potential new folder: Unfiled

- [ ] **D.** 3-Resources/Inbox/minecraft-beta.md — 40%  
  ⚠ Potential new folder: Inbox

- [ ] **E.** 3-Resources/Misc/minecraft-beta.md — 40%  
  ⚠ Potential new folder: Misc

- [ ] **F.** 3-Resources/New/minecraft-beta.md — 40%  
  ⚠ Potential new folder: New

- [ ] **G.** 3-Resources/Ideas/minecraft-beta.md — 40%  

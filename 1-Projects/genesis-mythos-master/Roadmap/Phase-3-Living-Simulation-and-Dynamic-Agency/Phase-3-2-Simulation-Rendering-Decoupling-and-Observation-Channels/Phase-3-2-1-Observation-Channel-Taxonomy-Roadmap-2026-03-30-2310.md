...
> [!note] #handoff-review
> `handoff_readiness: 85` — tertiary **3.2.1** — **observation channel taxonomy** aligned to **3.1.1** **lane + subscription** model and **3.1.3** **`preview_shadow`** vs **committed** session boundary (re-affirmed with **3.1.4** checkpoint gates). **D-3.1.5-*** remain **execution-deferred** with binding loci unchanged. **Tertiary 3.2.2** minted — [[Phase-3-2-2-Freshness-Drift-Policy-Classes-Roadmap-2026-04-02-2350]] (freshness / drift policy classes). Next structural cursor **3.2.3**.
...
- **3.2.2** — [[Phase-3-2-2-Freshness-Drift-Policy-Classes-Roadmap-2026-04-02-2350]] — freshness / drift policy classes (**tick_aligned** vs **frame_aligned**; **semantic_drift_bounded** vs **display_lag_disclosed**).
- **3.2.3** — (next tertiary) — UX / **D-3.1.5** binds **or** **3.2** rollup.

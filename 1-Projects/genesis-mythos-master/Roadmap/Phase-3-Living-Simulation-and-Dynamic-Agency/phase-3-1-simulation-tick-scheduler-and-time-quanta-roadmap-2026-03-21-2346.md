...
handoff_gaps:
  - "**Execution closure:** composite **EHR 68** on **3.1.7** until coordinated repo goldens — **does not** block normative **`advance-phase`** eligibility when `handoff_gate` + **min_handoff_conf 93** satisfied (**D-039**)."
  - "**G-P3.1-GOLDEN** remains **draft / non-frozen** until reconciled with **2.2.3** / **D-020** (**D-040**)."
links:

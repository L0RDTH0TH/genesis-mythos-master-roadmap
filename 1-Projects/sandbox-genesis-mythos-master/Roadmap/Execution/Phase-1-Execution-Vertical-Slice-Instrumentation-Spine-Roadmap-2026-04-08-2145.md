...
- [[Phase-1-3-FirstCommittedTick-Stub-Binding-Roadmap-2026-04-09-2210]] — **1.3** secondary (first committed tick / seed-bundle stub; correlates **6.1.2** → **1.1** `tick_commit_id` namespace).

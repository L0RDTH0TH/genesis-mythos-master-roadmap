...
**Dual roadmap track (conceptual vs execution):** See [[3-Resources/Second-Brain/Vault-Layout|Vault-Layout]] § Dual roadmap track, Conceptual-Amendments, **Conceptual-Decision-Records**, and [[3-Resources/Second-Brain/Docs/Dual-Roadmap-Track|Dual-Roadmap-Track]] (Definitions).

...
- **EAT-QUEUE**, **Process queue**, **eat cache** / **EAT-CACHE**, or a pasted **EAT-CACHE** payload (queue-based run; append one line per processed queue entry, using each entry's `id` as requestId), or

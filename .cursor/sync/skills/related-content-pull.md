...
2. **Search**: Call `obsidian_global_search` with a query derived from the note (keywords, themes) and optionally project-id or project name to find related notes.

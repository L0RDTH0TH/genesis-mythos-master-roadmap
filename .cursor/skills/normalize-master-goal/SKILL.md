...
- When **ROADMAP MODE – generate from outline** runs and the seed note is a PMG: run this skill **first** so the seed follows [[Templates/Roadmap/Master-Goal]] and phase parsing is reliable.
...
3. **Map content to template sections**
   - Use [[Templates/Roadmap/Master-Goal]] as the target structure:

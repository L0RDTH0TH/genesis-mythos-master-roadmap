...
- `compare_next_cycle_233000z_first_pass`: [[../../../../3-Resources/Second-Brain/Validator-Reports/roadmap_handoff_auto/sandbox-genesis-mythos-master-handoff-auto-exec-phase1-rollup-compare-next-20260408T233000Z-first-pass.md]]
- `compare_next_cycle_233000z_second_pass`: [[../../../../3-Resources/Second-Brain/Validator-Reports/roadmap_handoff_auto/sandbox-genesis-mythos-master-handoff-auto-exec-phase1-rollup-compare-next-20260408T233000Z-second-pass.md]]
...
- `compare_lineage_operator_replay_l1b`: supplementary replay (`eatq-sandbox-20260408-l1-b`) — first pass [[../../../../3-Resources/Second-Brain/Validator-Reports/roadmap_handoff_auto/sandbox-genesis-mythos-master-handoff-auto-l1b-exec-phase1-post-bootstrap-20260408T235200Z-first-pass.md]] with pinned lineage anchor (empty-bootstrap first pass, link above); **`tuple_state` remains `open_advisory`** until checklist clears rollup blocker-family codes.
...
- `postbootstrap_followup_chain_queue_id`: `followup-ha-exec-p1-postbootstrap-followup-chain-20260410T185500Z` (2026-04-10 handoff-audit chain; **superseded narrative:** nested **`Task(validator)`** first pass now recorded — see `postbootstrap_followup_chain_nested_first_pass_200500z` below; **`tuple_state` still `open_advisory`**.)
- `postbootstrap_followup_chain_nested_first_pass_200500z`: [[../../../../3-Resources/Second-Brain/Validator-Reports/roadmap_handoff_auto/sandbox-genesis-mythos-master-handoff-auto-exec-p1-postbootstrap-followup-chain-20260410T200500Z-first-pass.md]] — **receipt only** (`recommended_action: needs_work`, `primary_code: missing_roll_up_gates`); **not** a closure grant.
- `postbootstrap_followup_chain_nested_second_pass_compare_202000z`: [[../../../../3-Resources/Second-Brain/Validator-Reports/roadmap_handoff_auto/sandbox-genesis-mythos-master-handoff-auto-exec-p1-postbootstrap-followup-chain-20260410T200500Z-second-pass-compare.md]] — **compare receipt** (`regression_status: same`; rollup tuple **still** `open_advisory`; **not** a closure grant).

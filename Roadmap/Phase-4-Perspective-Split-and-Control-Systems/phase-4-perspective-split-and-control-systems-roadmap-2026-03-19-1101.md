...
| **G-P4-DM-SHELL** | DM free-cam + orthographic + shared control shell | **DEFERRED** per **D-059** until after **4.1** spine | [[decisions-log]] **D-059** |
...
- **DM orthographic / editor viewports** align with **tooling** patterns; **defer** detailed DM shell per **D-059** / **ARCH-FORK-02** ([[Ingest/Agent-Research/phase-4-primary-perspective-control-research-2026-03-24#3-first-person-vs-dm-orthographic-tooling-defer-dm-shell-per-d-059|§3]]).
...
- **D-059:** Do not expand **4.1** MVP to full **DM orthographic + shared shell**; track as later **4.x** secondary.

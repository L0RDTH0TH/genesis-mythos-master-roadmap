...
## Tertiary children (execution)

- **2.1.1** — [[Phase-2-1-1-SeedGraph-Stage-Drill-Stub-Roadmap-2026-04-07-2315]] (**SeedGraph** drill; queue `followup-deepen-exec-phase2-continuation-sandbox-gmm-20260409T231000Z`).

## Open questions

- **Resolved (2026-04-07):** First tertiary = **SeedGraph** drill (**2.1.1**) per stage ledger order (**`S2.1-SG`** before **`S2.1-TR`**); **Terrain** drill queued as **2.1.2** or later sibling per [[workflow_state-execution]].

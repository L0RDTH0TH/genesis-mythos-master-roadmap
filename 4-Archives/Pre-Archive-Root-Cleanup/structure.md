...
- 5-Attachments — binary files, images. Subfolders: PDFs/, Images/, Audio/, Documents/ (.docx/.xlsx/.pptx), Other/ (fallback). Subfolders: PDFs/, Images/, Audio/, Documents/ (.docx/.xlsx/.pptx), Other/ (fallback).

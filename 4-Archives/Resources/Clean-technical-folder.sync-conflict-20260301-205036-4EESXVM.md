...
3. **Old logs**: Clear or rotate `.technical/*.log`, `.technical/Watcher-Timing-Log.md`, `mcp-setup-log.md`, or other one-off logs when they grow large; keep pipeline logs (Ingest-Log, etc.) in `3-Resources/`.

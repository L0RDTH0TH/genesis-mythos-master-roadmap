---
title: obsidian_split_atomic (MCP tool)
created: 2026-02-23
...
**obsidian_split_atomic** — Split a note into atomic notes (Zettelkasten). Parameters: `path`, `split_on` (default "## "). Used in para-zettel-autopilot pipeline to break multi-topic ingest into single-idea notes.

## What does this seem to mean?

Supports atomicity; one thought per note. Outputs multiple new notes or paths.
